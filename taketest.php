...
<head>
    ...
    <title>Ravenclaw - The Knights Radiant Order Quiz</title>
</head>
<body>
        ...
        <nav>
            <div class="d-flex justify-content-between">
                ...
                <ul class="nav nav-pills align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="taketest.php">Take test</a>
                    </li>
                    <li class="nav-item">
...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        echo "<div class=\"margin-container\">\n";
        echo "<table noborder width=\"850\"><tr><td style=\"width: 170px;\"></td>";
